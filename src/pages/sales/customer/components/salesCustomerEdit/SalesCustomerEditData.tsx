...
import { ICustomerAdd, useGetCustomerByIdQuery, usePutCustomerMutation } from "../../../../../app/services/customer/customer";
...
const validationSchema = yup.object().shape({
  ...
  telegram_id: yup
    ...
    .required("Telegram_id talab qilinadi."),
});
...
const SalesCustomerAddData: React.FC<TUpdateUserDataProps> = ({
  ...
  const customerById = useGetCustomerByIdQuery({
    customerId
  })

  useEffect(() => {
    if (customerById.data?.success && customerById.data.data) {
      const { firstname, lastname, phone_number, telegram_id } =
        customerById.data.data;

      formik.setFieldValue("firstname", firstname);
      formik.setFieldValue("lastname", lastname);
      formik.setFieldValue("phone_number", phone_number);
      formik.setFieldValue("telegram_id", telegram_id);
    }
  }, [customerById]);
