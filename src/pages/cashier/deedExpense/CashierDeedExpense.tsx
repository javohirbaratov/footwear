...
const CashierDeedExpense: React.FC = () => {
  // Api
        ...
        <Grid container mb={4}>
          <Grid item xs={12}>
            <FormControl fullWidth margin="normal" size="small">
              <InputLabel id="demo-simple-select-label">Kategoriya</InputLabel>
              <Select
          ...
          <Grid item xs={12}>
            <FormControl fullWidth margin="normal" size="small">
              <InputLabel id="demo-simple-select-label">Sub kategoriya</InputLabel>
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={10}
...
export default CashierDeedExpense;